# PR 18: phase2: add auto-fix engine dry-run core

## Summary
This PR introduces the design and implementation contract for **phase2: add auto-fix engine dry-run core**.
...
## Detailed Plan
Introduce idempotent bounded auto-fix execution with dry-run mode.
