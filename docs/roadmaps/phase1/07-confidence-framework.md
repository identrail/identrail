# PR 07: phase1: introduce confidence scoring framework

## Summary
This PR introduces the design and implementation contract for **phase1: introduce confidence scoring framework**.
...
## Detailed Plan
Add structured confidence scoring pipeline and severity-compatible bands.
