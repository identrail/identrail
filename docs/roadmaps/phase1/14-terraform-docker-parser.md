# PR 14: phase1: integrate terraform and dockerfile parsers

## Summary
This PR introduces the design and implementation contract for **phase1: integrate terraform and dockerfile parsers**.
...
## Detailed Plan
Use HCL and Dockerfile parsers for context-aware misconfiguration detection.
