# PR 06: phase1: add evidence preview and redaction

## Summary
This PR introduces the design and implementation contract for **phase1: add evidence preview and redaction**.
...
## Detailed Plan
Attach redacted matched-snippet previews and reason metadata.
