# PR 15: phase1: upgrade finding output rendering

## Summary
This PR introduces the design and implementation contract for **phase1: upgrade finding output rendering**.
...
## Detailed Plan
Render enriched fields in CLI and API outputs with compatibility flag.
