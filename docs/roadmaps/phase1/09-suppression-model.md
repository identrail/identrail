# PR 09: phase1: add suppression model and persistence

## Summary
This PR introduces the design and implementation contract for **phase1: add suppression model and persistence**.
...
## Detailed Plan
Define suppression entities with owner, reason, scope, and expiry metadata.
