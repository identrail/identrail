# PR 08: phase1: add confidence calibration baselines

## Summary
This PR introduces the design and implementation contract for **phase1: add confidence calibration baselines**.
...
## Detailed Plan
Create calibration corpus and regression checks for score stability.
