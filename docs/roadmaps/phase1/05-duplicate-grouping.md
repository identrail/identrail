# PR 05: phase1: implement duplicate finding grouping

## Summary
This PR introduces the design and implementation contract for **phase1: implement duplicate finding grouping**.
...
## Detailed Plan
Group duplicate findings by fingerprint and emit occurrence counts with location lists.
