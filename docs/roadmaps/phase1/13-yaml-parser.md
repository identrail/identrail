# PR 13: phase1: integrate YAML parser checks

## Summary
This PR introduces the design and implementation contract for **phase1: integrate YAML parser checks**.
...
## Detailed Plan
Use YAML AST-backed checks for actions and kubernetes manifests.
