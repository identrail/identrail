# PR 12: phase1: add parser-first dispatch layer

## Summary
This PR introduces the design and implementation contract for **phase1: add parser-first dispatch layer**.
...
## Detailed Plan
Route rules through parser-aware analyzers before regex fallback.
