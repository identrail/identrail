# PR 16: phase1.5: add remediation suggestion framework

## Summary
This PR introduces the design and implementation contract for **phase1.5: add remediation suggestion framework**.
...
## Detailed Plan
Add deterministic fix-summary and secure-alternative guidance to findings.
