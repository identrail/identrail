# PR 10: phase1: enforce suppression expiry

## Summary
This PR introduces the design and implementation contract for **phase1: enforce suppression expiry**.
...
## Detailed Plan
Apply suppressions at read time and auto-expire stale suppressions.
