# PR 11: phase1: add baseline import export

## Summary
This PR introduces the design and implementation contract for **phase1: add baseline import export**.
...
## Detailed Plan
Add baseline snapshot and load flow with expiry-required policy.
