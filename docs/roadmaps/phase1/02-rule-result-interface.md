# PR 02: phase1: standardize rule result interface

## Summary
This PR introduces the design and implementation contract for **phase1: standardize rule result interface**.
...
## Detailed Plan
Unify detector return contract for match, reason, confidence inputs, evidence, and location.
