# PR 01: phase1: finding schema v2 core contract

## Summary
This PR introduces the design and implementation contract for **phase1: finding schema v2 core contract**.
...
## Detailed Plan
Define canonical finding schema fields, compatibility adapter, and migration checks.
