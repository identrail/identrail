...
func ValidateSecurity(cfg Config) error {
	...
	if cfg.FeatureConnectorAWS {
		...
		if !awsTemplateSHA256Pattern.MatchString(strings.TrimSpace(cfg.AWSCloudFormationTemplateSHA)) {
			return fmt.Errorf("IDENTRAIL_AWS_CFN_TEMPLATE_SHA256 must be a SHA-256 checksum when IDENTRAIL_FEATURE_CONNECTOR_AWS=true")
		}
