...
func TestOpenAPIV1SpecContainsTenancyProjectContracts(t *testing.T) {
	...
	required := []string{
		...
		"/v1/workspaces/{workspace_id}/projects/{project_id}/scan-policies:",
		...
		"AWSConnectionStatus:",
		"AWSConnectorScopeType:",
		"AWSConnectorDeploymentMethod:",
		"AWSConnectorOnboardingStatus:",
		"AWSConnectorNextAction:",
